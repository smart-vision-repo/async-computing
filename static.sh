...
compile() {
    ...
    # ✅ 清洗 pkg-config 输出中的错误链接标志
    AMQP_LIBS_STATIC=$(echo "$AMQP_LIBS_STATIC" | sed -E 's/-l([a-zA-Z0-9_]+)\.so\.[0-9.]+/-l\1/g')
